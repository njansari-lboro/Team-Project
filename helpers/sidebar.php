        <ul class="nav navbar-nav side-nav">
            ...
            <li class=''>
                <a href="index.php?page=employee&io=1"><i class="fa fa-fw fa-users"></i>Assigments</a>
            </li>
            <li>
                <a href="index.php?page=project_list&io=1"><i class="fa fa-fw fa-files-o"></i> Project List</a>
            </li>
            <!-- type example here i.e. admin is 1 -->
            <?php //if ($_SESSION['TYPE'] == 1) : 
            ?>
            <li class=''>
                <a href="index.php?page=tutorials"><i class="fa fa-users"></i>Tutorials</a>
            </li>
            <?php //endif; 
            ?>
            <li>
