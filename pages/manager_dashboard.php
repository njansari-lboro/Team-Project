...
<head>   
    ...
    <script src="manager_dashboard_script.js"></script>
    ...
    <link rel="stylesheet" href="manager_dashboard_style.css">
</head>
...
<body>
    ...
    <div class="container-fluid pt-2 pb-2 border rounded" id="dashboard">
        <div class="row">
            <div class="col-lg-3 pb-1" id="project_col">
                <select id="project_dropdown" class="form-control border-0 display-1"></select>
            </div>
            <div class="col-lg-1" id="spacing_col">-</div>
            <div class="col-lg-3 pb-1" id="date_col">
