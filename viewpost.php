...
<body>
    <div class="content-box">
        <div class="header">
            ...
            <h1><span class="topic-color">Topic</span> | <span class="question-title-color">Question Title</span></h1>
...
<script>
    ...
    exitButton.addEventListener('click', function() {
        window.location.href = 'Formus.php'; 
    });

 var replyButton = document.querySelector('.button');
